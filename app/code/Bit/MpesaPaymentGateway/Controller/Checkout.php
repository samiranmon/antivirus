class Bit_MpesaPaymentGateway_CheckoutController extends Mage_Core_Controller_Front_Action {
    public function process($MERCHANT_TRANSACTION_ID, $ENDPOINT,$PASSWORD,$TIMESTAMP)
    {
